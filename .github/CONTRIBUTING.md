# Contributing to Orderprocessing
...
```bash
# Clone the repo
git clone https://github.com/rushikesh-pande/orderprocessing.git
cd orderprocessing
...
Open a [Discussion](https://github.com/rushikesh-pande/orderprocessing/discussions) or
