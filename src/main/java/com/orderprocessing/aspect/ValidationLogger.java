 ...
 *
 * Auto-applied by CodeGen Agent after source scan of: orderprocessing
 */
@Aspect
@Component
@Slf4j
public class ValidationLogger {
    ...
    @Before("execution(* com.orderprocessing.controller..*(..)) && args(..,@jakarta.validation.Valid (*),..)")
    ...
    @Before("execution(* com.orderprocessing.controller..*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.orderprocessing.controller..*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* com.orderprocessing.controller..*(..))", throwing = "ex")
